...
def adapt_tabdpt_for_reconstruction(context_table, query_matrix,
    ...
    print(f"    Using n_ensembles={n_ensembles}, context_size={n_samples}")
    if n_batches > 1:
...
def tabdpt_rule_learning(dataset, max_antecedents=2, context_samples=None,
    ...
    # Adapt TabDPT for reconstruction
    ...
    for dataset_info in datasets:
        ...
        for run_idx in range(n_runs):
            ...
            extracted_rules, feature_names, original_data = tabdpt_rule_learning(
                ...
                cons_similarity=cons_similarity,
                n_ensembles=n_ensembles,
                random_state=run_seed  # Pass seed to TabDPT for reproducibility
            )
